...
SELECT 
  temps, co2Level,
  FILTER(temps, t -> t > 18) as HighTemps
...
SELECT 
  temps as Temps_InC,
  TRANSFORM (temps, t -> ((t * 9) div 5) + 32 ) As Temps_InF
FROM DeviceData1;
...
SELECT distinct device_type FROM Co2LevelsTemporary
